...
import { useCustomAnimation } from '@sonhaaa/test-playground'
...
export default function Boy({ ...props }: JSX.IntrinsicElements['group']) {
  ...
  const anim = useCustomAnimation({ animations: ['idle', 'run'] })
